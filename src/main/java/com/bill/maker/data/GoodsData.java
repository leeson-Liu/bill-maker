...
public class GoodsData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        GOOD_LIST.add(Good.builder().id(1).name("靴").mixPrice(750).maxPrice(4000).weight(9).build());//鞋
        GOOD_LIST.add(Good.builder().id(2).name("洋服").mixPrice(500).maxPrice(4000).weight(9).build());//西服
        GOOD_LIST.add(Good.builder().id(3).name("婦人肌着").mixPrice(250).maxPrice(700).weight(6).build());//女士内衣
        GOOD_LIST.add(Good.builder().id(4).name("靴下").mixPrice(100).maxPrice(300).weight(5).build());//袜子
        ...
        GOOD_LIST.add(Good.builder().id(9).name("サプリメント").mixPrice(200).maxPrice(1000).weight(5).build());//保健食品
        ...
        GOOD_LIST.add(Good.builder().id(12).name("電気製品").mixPrice(500).maxPrice(1000).weight(1).build());//电器
        GOOD_LIST.add(Good.builder().id(13).name("生活雑貨").mixPrice(100).maxPrice(1000).weight(0).build());//生活杂货
        GOOD_LIST.add(Good.builder().id(14).name("食品").mixPrice(50).maxPrice(300).weight(1).build());//食品
