...
public class GoodsData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        GOOD_LIST.add(Good.builder().id(6).name("パジャマ").mixPrice(400).maxPrice(1500).weight(5).build());//睡衣
        GOOD_LIST.add(Good.builder().id(7).name("下着").mixPrice(200).maxPrice(400).weight(4).build());//内衣(内裤，胸罩等)
        ...
        GOOD_LIST.add(Good.builder().id(10).name("子供靴").mixPrice(400).maxPrice(1200).weight(4).build());//儿童鞋
        GOOD_LIST.add(Good.builder().id(11).name("育児雑貨").mixPrice(100).maxPrice(1000).weight(4).build());//育儿杂货
        GOOD_LIST.add(Good.builder().id(12).name("ベビー洋品雑貨").mixPrice(200).maxPrice(500).weight(4).build());//婴儿用品
        GOOD_LIST.add(Good.builder().id(13).name("帽子").mixPrice(600).maxPrice(3000).weight(6).build());//帽子
        GOOD_LIST.add(Good.builder().id(14).name("化粧品").mixPrice(400).maxPrice(4000).weight(8).build());//化妆品
        GOOD_LIST.add(Good.builder().id(15).name("化粧品雑貨").mixPrice(200).maxPrice(500).weight(3).build());//化妆用品
        ...
        GOOD_LIST.add(Good.builder().id(18).name("財布").mixPrice(500).maxPrice(2000).weight(4).build());//钱包
        ...
        GOOD_LIST.add(Good.builder().id(21).name("チャ－ム").mixPrice(300).maxPrice(2000).weight(5).build());//小型饰品
        GOOD_LIST.add(Good.builder().id(22).name("キ－ホルダー").mixPrice(300).maxPrice(1000).weight(4).build());//钥匙扣
        GOOD_LIST.add(Good.builder().id(23).name("サプリメント").mixPrice(200).maxPrice(1000).weight(6).build());//保健食品
        GOOD_LIST.add(Good.builder().id(24).name("健康食品").mixPrice(200).maxPrice(500).weight(4).build());//保健品
        ...
        GOOD_LIST.add(Good.builder().id(39).name("ゲーム機").mixPrice(2500).maxPrice(4000).weight(3).build());//游戏机
        ...
        GOOD_LIST.add(Good.builder().id(47).name("菓子").mixPrice(50).maxPrice(300).weight(4).build());//零食
        GOOD_LIST.add(Good.builder().id(48).name("茶葉").mixPrice(150).maxPrice(300).weight(2).build());//茶叶
